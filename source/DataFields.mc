...
module DataFields {
	...
	*/
	...
	function drawAlien(dc, left) {
		...
		iconLocX = width / 2 - 25;
		iconLocY = height / 2 + 60;
		
		// Draw icon and text
		dc.drawBitmap(iconLocX, iconLocY, WatchUi.loadResource(Rez.Drawables.AlienIcon));
